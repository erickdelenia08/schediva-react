  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-slate-800 p-4 transition-all duration-200 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-64'
          }`}
      >
        ...
        <div className="flex flex-col justify-between items-center mb-10 pr-3 sm:px-2 ">
          ...
          <span className='pt-3 text-xl uppercase font-bold text-slate-300 pointer-events-none'>Schediva</span>
        </div>
